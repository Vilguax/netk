          ...
          <div className="relative rounded-2xl bg-slate-900/50 border border-slate-700/50 backdrop-blur-xl overflow-hidden">
            ...
            <div className="relative p-8 text-center">
              ...
              <p className="text-slate-400 mb-6">
                Un email de vérification a été envoyé à <span className="text-cyan-400">{email}</span>.
    ...
    <div className="min-h-screen bg-black text-white overflow-hidden relative flex items-center justify-center">
      ...
      <div className="relative z-10 w-full max-w-md px-6">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-slate-400">Créez votre compte pilote</p>
        </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex items-start gap-3 pt-2">
                <input
                  ...
                  className="mt-1 w-4 h-4 rounded border-slate-700/50 bg-slate-800/50 text-cyan-500 focus:ring-cyan-500/30 focus:ring-offset-0"
                />
